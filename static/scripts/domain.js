...
$("#strat").change(function () {
    ...
    if (id == "Email based validation") {
        ...
        $('#div_t2').show()
        var options = $('#sel1');
        const edutu2 = 'https://api.xposedornot.com/v1/domain_verification?z=c&d=' + $('#eventName').val()
...
$("#searchMe_e").click(function (func_alert6) {
    ...
    const edutu4 = 'https://api.xposedornot.com/v1/domain_verification?z=d&d=' + $('#eventName').val() + '&a=' + $('#txt_email_e').val() + '&ae=' + $('#sel1').val()
...
$("#searchMe_d").click(function (func_alert) {
    ...
    const edutu4 = 'https://api.xposedornot.com/v1/domain_verification?z=e&d=' + $('#eventName').val() + '&e=xon_verification' + '&v=' + $('#hid1').val() + '&a=' + $('#txt_dns').val()
...
$("#searchMe_m").click(function (func_alert3) {
    ...
    const edutu3 = 'https://api.xposedornot.com/v1/domain_verification?z=v&d=' + $('#eventName').val() + '&e=xon_verification' + '&v=' + $('#hid1').val() + '&a=' + $('#txt_email_m').val()
...
$("#searchMe_h").click(function (func_alert4) {
    ...
    const edutu4 = 'https://api.xposedornot.com/v1/domain_verification?z=a&d=' + $('#eventName').val() + '&e=xon_verification' + '&v=' + $('#hid1').val() + '&a=' + $('#txt_email_h').val()
